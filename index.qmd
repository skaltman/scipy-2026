...
<br>
<br>
1. LLMs are great performers, but not always reliable reporters.
:::
...
<ul>
<li class="fragment" data-fragment-index="1">Help them get it right.</li>
...
::: {style="display: flex; flex-direction: column; justify-content: center; min-height: 65vh;"}
...
::: notes
lots of coding agents out there you can use for data analysis
we'll use Posit Assistant as our running example
but everything here applies broadly -- and these lessons are most
pertinent if you're building your own agent
:::
...
::: {style="display: inline-block; text-align: left; font-size: 1.05em; line-height: 1.9; margin-top: 50px;"}
<ul>
<li class="fragment toc-emph" data-fragment-index="1">Help them get it right</li>
...
but you control the harness -- this is what you shape, whether you use an agent like Posit Assistant or build your own
...
::: {.incremental}
* You don't always want the model writing code from scratch
* If you have code you trust, have the agent reuse it
:::

::: notes
models are good at writing code, but you don't always want them authoring it fresh
if you already have vetted code use that
:::
...
<ul>
<li class="fragment semi-fade-out" data-fragment-index="1">Help them get it right</li>
<li class="fragment toc-emph" data-fragment-index="1">Make it matter less when they're wrong
<ul style="font-size: 0.8em; line-height: 1.7; margin-top: 12px; opacity: 0.9; font-weight: 400;">
<li class="fragment" data-fragment-index="2">Lean on code as a foundation</li>
<li class="fragment" data-fragment-index="3">Design for how it'll actually be used</li>
</ul>
</li>
</ul>
</div>
...
You want a chance to catch mistakes
...
## Design for how it'll actually be used

::: {.incremental}
* How will people actually work with your agent?
* What does that mean for correctness and reproducibility?
:::

::: notes
this one is less a universal rule, more a design question you answer for your own agent
think through how people will actually interact with it, and how that affects correctness and reproducibility
our answer for data analysis comes next -- because the point of analysis is understanding, we made posit assistant pause often
:::
...
::: {.fragment}
[LLMs are great performers, but not always reliable reporters]{style="font-weight: 700; font-size: 1.4em;"}

::: {style="font-size: 0.95em; margin-top: 12px; line-height: 1.5; opacity: 0.9;"}
• Can and will confidently make errors  <br>
:::
:::
