...
::: {style="font-size: 2em; text-align: left; color: #093A3E; font-weight: 700;"}
<br>
<br>
<br>
1. LLMs are weird. 
...
## {background-color="#F6FAFD" auto-animate=true}
...
::: {.fragment style="background-color: #F6FAFD; border-radius: 18px; padding: 18px 32px; box-shadow: 0 4px 16px rgba(0,0,0,.2);"}
