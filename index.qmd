...
<br>
<br>
1. LLMs fail at tasks central to data science.

::: {style="font-size: 0.6em; font-weight: 400; margin-left: 1.5em;"}
- Models largely fail to override priors about data
- Models fail to notice some subtle data quality issues
:::
:::
...
::: {.fragment}
[LLMs can fail at tasks central to data science.]{style="font-weight: 700; font-size: 1.4em;"}
:::
