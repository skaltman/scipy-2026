...
You control the <span style="position:relative; display:inline-block;"><span class="fragment fade-out" data-fragment-index="1">_environment_</span><span class="fragment fade-in" data-fragment-index="1" style="position:absolute; left:0; top:0; font-weight:700; white-space:nowrap;">harness</span></span> around the model, not the model itself
...
::: {style="display: flex; flex-direction: column; justify-content: center; align-items: center; min-height: 70vh; gap: 40px;"}
