...
![](figures/tips-bill-tip-thumb.png){fig-alt="A small scatterplot thumbnail with total_bill on the x-axis and tip on the y-axis. The points drift downward from upper left to lower right, suggesting a negative association." width="160px" style="border-radius: 12px; display: block;"}
...
![](figures/tips-bill-tip-thumb.png){fig-alt="The same tips plot." width="160px" style="border-radius: 12px; display: block;"}
:::
...
#| echo: false
#| fig-align: center
#| fig-alt: "A scatterplot of BMI against cholesterol with a positive trend. A subset of points falls exactly along a straight line."
...
![](figures/posit-assistant-python.png){fig-align="center" width="820" fig-alt="A screenshot of Positron running Posit Assistant: the assistant chat sits on the left, a Python console in the middle, and a Session panel with plots and variables on the right. The assistant has produced a map of Washington colored by forested status."}
...
![](figures/posit-assistant-python-code.png){fig-align="center" fig-alt="The Posit Assistant screenshot with an orange box drawn around the assistant's executeCode block, showing the Python source it ran to build an elevation histogram colored by forested status."}
...
![](figures/posit-assistant-python-console.png){fig-align="center" fig-alt="The Posit Assistant screenshot with orange circles around matching code in the assistant panel and in the shared Python console."}
